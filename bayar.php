...
if($aksi=='bayar'){
    ...
    $update = $dbo->update("tborders","total = $total,diskon=$diskon,pajak=$pajak,bayar='$bayar',kembali=$kembalian","idorder=".$_GET['idorder']);
    if($update){
        ?>
        <script>
...
<div class="data">
    ...
    <?php
    $datamenu = $dbo->select("tborderdetail a, tbmenu b where a.idmenu = b.idmenu and a.idorder=$id","a.*,b.nama_menu");
        $no=1;
        $total=0;
